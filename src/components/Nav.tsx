      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-6 py-4">
        ...
        <nav className="hidden items-center gap-1 md:flex">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="ml-2 inline-flex items-center gap-1.5 rounded-full bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow-[0_8px_30px_-8px_var(--electric)] transition-transform hover:scale-[1.02]"
          >
            Register
          </a>
        </nav>
